...
c      implicit double precision(a-h,o-z)
     ...
     & gglast(3,mnat),gflast(3,mnat),diffgf(3,mnat),diffgg(3,mnat)
      ...
      qcprog=2       ! Gaussian as default program package
...
c set these
      etol = 1.d-2   ! energy gap convergence tolerance in kcal/mol
      gtol = 1.d-2   ! gradient norm convergence tolerance in Hartree/bohr
