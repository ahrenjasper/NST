...
c **********************************************************************
      ...
      subroutine pot(symb,x,y,z,pemd,gpemd,nat,mnat,nsurf,mnsurf,qcprog)
...
c in/out
      integer nat,mnat,nsurf,mnsurf,qcprog
...
c           = 2 for Molpro 2006
      ...
      ns(2) = 1
      np(2) = 2
c QC package determined by last argument of subroutine call
      np(1) = qcprog
      np(2) = qcprog
      tname(1) = "qc.3"
      tname(2) = "qc.1" 
